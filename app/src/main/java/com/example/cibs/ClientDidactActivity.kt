...
import com.example.cibs.viewModel.RestoViewPageprivateAdapter
...
class ClientDidactActivity : AppCompatActivity() {
    ...
    private val imageList = mutableListOf<Int>(R.drawable.repas_afrique, R.drawable.commander2, R.drawable.livraison)
    var count: Int  = 0
