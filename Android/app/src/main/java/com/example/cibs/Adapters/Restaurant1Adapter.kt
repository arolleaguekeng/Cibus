...
class Restaurant1Adapter(private val itemClickListener: Restaurant1ClickListener): RecyclerView.Adapter<Restaurant1Adapter.viewHolder>() {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): Restaurant1Adapter.viewHolder {
        return viewHolder(LayoutInflater.from(parent.context).inflate(R.layout.item_horizontal2, parent, false))
    }

    override fun onBindViewHolder(holder: Restaurant1Adapter.viewHolder, position: Int) {
